...
Our PHDNet has been integrated into [libcom](https://github.com/bcmi/libcom) toolbox. Try this [online demo](http://libcom.ustcnewly.com/) for image composition (object insertion) built upon [libcom](https://github.com/bcmi/libcom) toolbox and have fun!
